...
if (!empty($programmes_achetes)) {
    ...
    // Join through programme_exercices table
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover">
                <div class="p-6">
                    <div class="flex items-start justify-between mb-2">
                        ...
                        ?>
                        <span class="px-2 py-1 bg-<?php echo $difficultyColor; ?>-100 text-<?php echo $difficultyColor; ?>-700 text-xs rounded-full">
                            <?php echo ucfirst($exo['niveau_difficulte']); ?>
                        </span>
                    </div>
                    <p class="text-gray-600 mb-2">
                        <i class="fas fa-tag mr-1 text-purple-500"></i>
                        <?php echo htmlspecialchars($exo['categorie']); ?>
                    </p>
                    ...
                    <?php if (!empty($exo['video_url'])): ?>
                        <div class="mt-4">
                            ...
                            <?php else:
                                ...
                                <?php else: ?>
                                    <a href="<?php echo htmlspecialchars($video); ?>" target="_blank" class="text-purple-600">Lien vidéo externe</a>
                                <?php endif;
                            endif; ?>
                        </div>
                    <?php endif; ?>
